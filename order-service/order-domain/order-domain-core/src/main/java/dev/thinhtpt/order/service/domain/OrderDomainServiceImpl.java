...
public class OrderDomainServiceImpl implements OrderDomainService {
    ...
    private static final String SYSTEM_TIMEZONE = "VST";
    ...
    public OrderCreatedEvent validateAndInitiateOrder(Order order, Restaurant restaurant) {
        ...
        return new OrderCreatedEvent(order, getCurrentZoneDateTime());
    }
    ...
    public OrderPaidEvent payOrder(Order order) {
        ...
        return new OrderPaidEvent(order, getCurrentZoneDateTime());
    }
    ...
    public OrderCancelledEvent cancelOrderPayment(Order order, List<String> failureMessages) {
        ...
        return new OrderCancelledEvent(order, getCurrentZoneDateTime());
    }
    ...
    private ZonedDateTime getCurrentZoneDateTime() {
        return ZonedDateTime.now(ZoneId.of(ZoneId.SHORT_IDS.get(SYSTEM_TIMEZONE)));
    }
}
